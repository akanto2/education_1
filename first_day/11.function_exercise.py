...
def by_three(number1=0, number2=0):     # 에러가 나지 않게 하기위해 파라미터에 '=0'을 기본으로 넣는다. default 값은 0이다.
    """
...
def main():
    print(by_three(number1=30_000_000_000_366))      # 코드에 가독성을 넣어주기위해 파라미터인 "number"을 입력해 줄 수 있다.
    print(by_three())
